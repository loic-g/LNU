...
import jmines.events.GameBoardEvent;
import jmines.events.GameBoardListener;
import jmines.listeners.KeyListenerForMainFrame;
import jmines.listeners.WindowListenerForMainFrame;
...
public final class MainFrame extends JFrame implements GameBoardListener {
     ...
     * @see jmines.events.GameBoardListener#initialized(jmines.events.GameBoardEvent)
     */
     ...
     *
     * @param evt The event object relating the event that occurred.
     * @see jmines.events.GameBoardListener#defeat(jmines.events.GameBoardEvent)
     */
     ...
     *
     * @param evt The event object relating the event that occurred.
     * @see jmines.events.GameBoardListener#victory(jmines.events.GameBoardEvent)
     */
