...
import jmines.actions.board.Hexagonal;
import jmines.actions.board.Octosquare;
import jmines.actions.board.Parquet;
import jmines.actions.board.Pentagonal;
import jmines.actions.board.Square;
import jmines.actions.board.Triangular;
import jmines.actions.board.Triangular14;
import jmines.actions.displayandsounds.Antialiasing;
import jmines.actions.displayandsounds.ChangeBackgroundColor;
import jmines.actions.displayandsounds.ChangeButtonsColor;
import jmines.actions.displayandsounds.ChangeColor;
import jmines.actions.displayandsounds.ChangeLCDColor;
import jmines.actions.displayandsounds.ChangeLookAndFeel;
import jmines.actions.displayandsounds.Shadow;
import jmines.actions.game.Beginner;
import jmines.actions.game.BestTimes;
import jmines.actions.game.Color;
import jmines.actions.game.Custom;
import jmines.actions.game.Expert;
import jmines.actions.game.Intermediate;
import jmines.actions.game.Marks;
import jmines.actions.game.New;
import jmines.actions.game.Quit;
import jmines.actions.game.Sound;
import jmines.actions.info.About;
import jmines.actions.info.Thanks;
import jmines.actions.language.Language;
import jmines.actions.other.LoadBoard;
import jmines.actions.other.LoadVideo;
import jmines.actions.other.SaveBoard;
import jmines.actions.other.SaveScreenshot;
import jmines.actions.other.SaveVideo;
import jmines.actions.robot.Cheat;
import jmines.actions.robot.Help;
import jmines.actions.robot.Name;
import jmines.actions.robot.Play;
import jmines.actions.robot.RandomTries;
import jmines.actions.robot.RealClicks;
import jmines.actions.robot.Statistics;
import jmines.listeners.MouseListenerForMenuItem;
