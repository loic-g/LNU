...
public class Parquet extends JMinesAction {
    ...
    //==========================================================================
    /**
     * Construct a new Parquet action.
     *
     * @param name The name of the menu item.
     * @param mainFrame The main frame of the application.
     */
    public Parquet(final String name, final MainFrame mainFrame) {
    ...
    public final void actionPerformed(final ActionEvent evt) {
        try {
            getMainPanel().getGamePanel().getGameBoard().setTilesShape(GameBoard.SHAPE_PARQUET);

            int width = getMainPanel().getGamePanel().getGameBoard().getWidth();
            int height = getMainPanel().getGamePanel().getGameBoard().getHeight();
            int maxMines = GameBoard.getMaxMines(GameBoard.SHAPE_PARQUET, width, height);
