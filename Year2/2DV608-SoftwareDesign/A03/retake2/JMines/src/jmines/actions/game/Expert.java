...
/**
 * The class representing the action used when the user click the Expert menu
 * item.
 *
 * @author Zleurtor
 */
public class Expert extends JMinesAction {
     ...
     */
    private static final long serialVersionUID = -3113725712802673289L;
    ...
    //==========================================================================
    /**
     * Construct a new Expert action.
     *
     * @param name The name of the menu item.
     * @param mainFrame The main frame of the application.
     */
    public Expert(final String name, final MainFrame mainFrame) {
        super(name, mainFrame);

        setStatusText(Configuration.getInstance().getText(Configuration.KEY_STATUSTEXT_GAME_EXPERT));
    }
     ...
     * setting the difficulty to Expert.
     *
    ...
    public final void actionPerformed(final ActionEvent evt) {
        ...
        String difficulty = Configuration.DIFFICULTY_EXPERT;
