...
import jmines.dialogs.ThanksDialog;
import jmines.panels.MainFrame;
import jmines.persistence.Configuration;

/**
 * The class representing the action used when the user click the Thanks menu
 * item.
 *
 * @author Zleurtor
 */
public class Thanks extends JMinesAction {
    ...
    //==========================================================================
    /**
     * Construct a new Thanks action.
     *
     * @param name The name of the menu item.
     * @param mainFrame The main frame of the application.
     */
    public Thanks(final String name, final MainFrame mainFrame) {
        super(name, mainFrame);

        dialog = new ThanksDialog(mainFrame.getMainPanel());
     ...
     * dialog displaying thanks for JMines.
     *
