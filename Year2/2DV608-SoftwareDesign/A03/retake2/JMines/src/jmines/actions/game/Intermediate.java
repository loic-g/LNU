...
/**
 * The class representing the action used when the user click the Intermediate
 * menu item.
 *
 * @author Zleurtor
 */
public class Intermediate extends JMinesAction {
    ...
    //==========================================================================
    /**
     * Construct a new Intermediate action.
     *
     * @param name The name of the menu item.
     * @param mainFrame The main frame of the application.
     */
    public Intermediate(final String name, final MainFrame mainFrame) {
     ...
     * setting the difficulty to Intermediate.
     *
    ...
    public final void actionPerformed(final ActionEvent evt) {
        ...
        String difficulty = Configuration.DIFFICULTY_INTERMEDIATE;
